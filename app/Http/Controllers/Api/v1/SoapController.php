...
class SoapController extends Controller
{
    ...
    public function upload()
    {
        try {
            ...
            <FACTURA>
              <ENC>                                       <!-- ENCABEZADO -->
                  <ENC_1>INVOIC</ENC_1>                     <!-- Tipo de Documento - Excel Simplificado Anexo - Estandar Simplificado - OK -->
                  <ENC_2>901143311</ENC_2>                  <!-- NIT CUENTA DEMO 901143311 - OK Constante para Pruebas --> 
              ...
              <EMI>                                       <!-- EMISOR -->
                  ...
                  <EMI_2>901143311</EMI_2>                  <!-- NIT Emisor - RUT - OK Constante para Pruebas --> 
                  ...
                  <DFE>                                   <!-- INFORMACION FISCAL EMISOR -->
                    ...
                    <DFE_4>190003</DFE_4>                   <!-- Tabla 39 - Código Postal - Excel Simplificado Anexo - Tablas 2.1 - OK Constante 19001 -->
              ...
              <ADQ>                                       <!-- ADQUIRIENTE -->
                  ...
                  <DFA>                                    <!-- INFORMACION FISCAL ADQUIRIENTE - OPCIONAL -->
                    ...
                    <DFA_3>190003</DFA_3>                   <!-- Tabla 39 - Código Postal - Excel Simplificado Anexo - Tablas 2.1 - OK Constante 19001 -->
                  ...
                  <CDA>                                     <!-- INFORMACION CONTACTO ADQUIRIENTE - OPCIONAL -->
                    <CDA_1>1</CDA_1>                        <!-- Tipo de Contacto - Excel Simplificado Anexo -->
                    <CDA_2>varios null varios</CDA_2>       <!-- Nombre de contacto, del cliente -->
                    <CDA_3>583100</CDA_3>                   <!-- Celular de contacto, del cliente -->
                    <CDA_4>null</CDA_4>                     <!-- Correo de contacto, del cliente -->
                  </CDA>
              ...
              <TIM>                                       <!-- TOTAL IMPUESTOS -->
                ...
                <IMP>                                     <!-- IMPUESTOS -->
                  ...
                  <IMP_5>COP</IMP_5>                        <!-- Tabla 13 - Monedas - Excel Simplificado Anexo - Tablas 2.1 - OK ConstanteD -->
              ...
              <ITE>                                       <!-- ITEMS DEL DOCUMENTO - ITERATIVO -->
    ...
    public function status()
    {
        try {
            ...
            $result = $client->__soapCall('FtechAction.documentStatusFile', [
                'username' => 'MACO02062024',
                'password' => '2a4d4a72f5aacf82e517cad6943fd3891157a52d8ed5a6fddedbbd31632035e8',
                'transaccionID' => 'fxeltktkjmwrai054cxwvi4b8sqgom59',
            ]);

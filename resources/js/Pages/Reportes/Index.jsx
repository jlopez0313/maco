...
export default function Reportes({ auth }) {
    const titles = ["Reporte", "Descripción"];
    ...
    const list = [
        ...
        },
        {
            ...
            descripcion:
                "Reporte indica el registro de las ventas realizadas hasta el momento.",
        ...
        },
        {
            ...
            descripcion:
                "Reporte indica el registro de los Gastos realizados hasta el momento.",
        ...
        },
        {
            ...
            descripcion:
                "Reporte Completo de los diferentes Clientes que tienen saldo por pagar hasta el momento.",
        ...
        },
        {
            ...
            descripcion:
                "Reporte unitario del saldo por pagar que tiene el cliente especifico consultado.",
        ...
        },
        {
            ...
            descripcion:
                "Muestra las perdidas o ganancias que ha tenido la compañia.",

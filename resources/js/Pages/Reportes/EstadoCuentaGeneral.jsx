...
export default function Reportes({ auth }) {
    ...
    const onSearch = async () => {
        const {
            data: { data: lista },
        } = await axios.post(`/api/v1/reportes/estado_cuenta_general`, data);
                ...
                <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    ...
                    */}
                                <SecondaryButton
                                    ...
                                    onClick={() =>
                                        goToQR(
                                            `/reportes/estado_cuenta_general/qr?fecha_inicial=${data.fecha_inicial}&fecha_final=${data.fecha_final}`
                                        )
                                    }
                                >
                                    QR
